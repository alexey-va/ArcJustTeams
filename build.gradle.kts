...
dependencies {
    ...
    implementation("ru.ruscrafting.arc:arc-core:2.7.13")
    implementation("ru.ruscrafting.arc:arc-core-logging:2.7.13")
    implementation("ru.ruscrafting.arc:arc-core-paper:2.7.13")
    implementation("ru.ruscrafting.arc:arc-core-menu:2.7.13")
    implementation("ru.ruscrafting.arc:arc-core-paper-menu:2.7.13")
    compileOnly("ru.ruscrafting.arc:arc-core-paper-api:2.7.13")
    ...
    testImplementation("ru.ruscrafting.arc:arc-core-paper-testing:2.7.13")
